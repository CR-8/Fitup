...
const parseDistanceInput = (input: string) => {
...
export const DistanceInput: FC<DistanceInputProps> = ({
    ...
    const fallbackText = useMemo(() => formatDistance(baseValue), [baseValue]);
    ...
    const handleChangeText = (t: string) => {
        ...
        setSelection({ start: end, end });
        onCommitValue(parseDistanceInput(normalized));
    };
