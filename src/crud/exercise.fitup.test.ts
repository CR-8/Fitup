// @ts-nocheck
const SOURCE_EXERCISE_ID = 'fitupSourceExercise01';
const FORK_EXERCISE_ID = 'fitupForkExercise01';
...
const mockSourceExercise = {
    ...
    description: 'Fitup description',
    difficulty: 'beginner',
    gifFilename: 'sk_bench-fitupSourceExercise01',
    userId: '__fitup__',
...
describe('exercise fitup flow', () => {
    ...
    test('forks fitup exercise, sets fitupSourceId and remaps workout exercises', async () => {
        ...
        expect(savedExercise.fitupSourceId).toBe(SOURCE_EXERCISE_ID);
        ...
        expect(savedExercise.gifFilename).toBe('sk_bench-fitupSourceExercise01');
        ...
        expect(mockInsertedExercise).toEqual(
            expect.objectContaining({
                ...
                userId: USER_ID,
                source: 'user',
                fitupSourceId: SOURCE_EXERCISE_ID,
                name: 'Edited Name',
                description: 'Edited description',
                equipment: ['barbell', 'bench'],
                mistakes: ['Elbows too wide'],
