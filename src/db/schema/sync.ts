...
export type FitupSyncMetadataSelect = typeof fitupSyncMetadata.$inferSelect;
export type FitupSyncMetadataInsert = typeof fitupSyncMetadata.$inferInsert;
...
export const fitupSyncMetadata = sqliteTable('fitup_sync_metadata', {
